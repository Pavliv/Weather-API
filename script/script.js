// Autofill for City Name input and Autofill coords
...
// $.getJSON('https://api.darksky.net/forecast/3f95a4d1d8e23a842b69f3c83a40fcda/37.8267,-122.4233', function(forecast) {
...
function weatherReport(latitude, longitude) {
	...
	var apiKey       = 'https://api.darksky.net/forecast/3f95a4d1d8e23a842b69f3c83a40fcda/37.8267,-122.4233',
...
$('button').on('click', function(e) {
	...
	if(lat && long !== '') {
		...
		$('.input-form').fadeOut(100, function() {
			...
			$('.custom-container').append('<button id="back">New Forecast</button><h3 class="city">' + city_name + '</h3><ul class="list-reset fadein-stagger" id="forecast"></ul>');
		});
	}
});
